...
All skill stores should follow [`SchemaSkillStore`](https://github.com/RavenLens/Raven-ADK/blob/main/documentation/src/agent/skills/stores/schema.ts).
...
* Local disk store: [`SkillDiskStore`](https://github.com/RavenLens/Raven-ADK/blob/main/documentation/src/agent/skills/stores/diskStore.ts)
* MongoDB store: [`SkillMongoDBStore`](https://github.com/RavenLens/Raven-ADK/blob/main/documentation/src/agent/skills/stores/mongodbStore.ts)

You can also build custom stores by implementing [`SchemaSkillStore`](https://github.com/RavenLens/Raven-ADK/blob/main/documentation/src/agent/skills/stores/schema.ts).
