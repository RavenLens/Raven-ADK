    ...
    it("should correctly trigger events and follow BFS logic with mocked outputs", async () => {
        ...
        mockEvaluator.invokeStructuredOutput.mockResolvedValueOnce({
            messages: [{
                ...
                structuredOutput: {
                    ratings: [
                        { id: "opt-1", rate: { decision: "good", score: 0.9, justification: "Great" } },
                        { id: "opt-2", rate: { decision: "good", score: 0.8, justification: "Good" } }
                    ]
                }
            }]
        });
        ...
        mockEvaluator.invokeStructuredOutput.mockResolvedValueOnce({
            messages: [{
                type: "ai",
                structuredOutput: {
                    topOptions: [{ id: "opt-1", type: "option-node", content: "Option 1" }]
                }
            }]
        });
        ...
        mockGenerator.invokeStructuredOutput.mockResolvedValueOnce({
            messages: [{
                ...
                structuredOutput: {
                    thoughts: [
                        { id: "th-1", type: "though-node", content: "Step 1", dependingThoughNodes: [] }
                    ]
                }
            }]
        });
        ...
        mockEvaluator.invokeStructuredOutput.mockResolvedValueOnce({
            messages: [{
                ...
                structuredOutput: {
                    ratings: [
                        { id: "th-1", rate: { decision: "good", score: 0.95, justification: "Logical step" } }
                    ]
                }
            }]
        });
        ...
        mockEvaluator.invokeStructuredOutput.mockResolvedValueOnce({
            messages: [{
                type: "ai",
                structuredOutput: {
                    topThoughts: [{ id: "th-1", type: "though-node", content: "Step 1", dependingThoughNodes: [] }]
                }
            }]
        });
        ...
        mockEvaluator.invokeStructuredOutput.mockResolvedValueOnce({
            messages: [{
                ...
                structuredOutput: {
                    ratings: [
                        { id: "opt-1", rate: { decision: "good", score: 0.99, justification: "Verified chain" } }
                    ]
                }
            }]
        });
        ...
        mockEvaluator.invokeStructuredOutput.mockResolvedValueOnce({
            messages: [{
                type: "ai",
                structuredOutput: {
                    theBestOption: [{ id: "opt-1", type: "option-node", content: "Option 1" }]
                }
            }]
        });
        ...
        const tot = new TreeOfThoughts({
            ...
            maxThoughtsDepth: 1,
            thoughtsCount: 1,
            graphSearchAlgorithm: new BFSToT({ topK: 1, pruneAtBegining: true }),
